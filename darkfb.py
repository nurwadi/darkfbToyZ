...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang \033[1;92m" +nama+ "\n\033[1;97mSelamat datang di tools Nurwadi ToyZA Darkfb !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	...
	if username =="NURWADIETG" and password =="darkfb":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UC95c6FWkUAA3Z8D0Z0Ub5Yg')
				menu()
